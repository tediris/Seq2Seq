...
def setup_args():
    ...
    source_dir = os.path.join("dialog_corpus", "movie")
...
if __name__ == '__main__':
    ...
    create_vocabulary(vocab_path,
                      [pjoin(args.source_dir, "train.enc"),
                       pjoin(args.source_dir, "train.dec"),
                       pjoin(args.source_dir, "test.enc"),
                       pjoin(args.source_dir, "test.dec")])
